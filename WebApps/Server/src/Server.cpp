...
void AppServer::restartGameVsAi(const http::HttpRequest &req, http::HttpResponse *resp)
{
    // 解析请求体
...
// 获取后台数据
void AppServer::getBackendData(const http::HttpRequest &req, http::HttpResponse *resp)
{
    try 
    {
        // 获取数据
...
void AppServer::packageResp(const std::string &version,
